...
// ============= Log Callback API (line-oriented) =============================
// Lets the GUI capture engine logs (one whole line per call).
typedef void (*engine_log_cb)(const char* line, void* user);
ENGINE_API void engine_set_log_cb(engine_log_cb cb, void* user);
